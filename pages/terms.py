...
layout = html.Div(id='terms', children=[
    html.H3("TERMS AND CONDITIONS"),
    html.P("These terms and conditions (the \"Terms and Conditions\") govern the user of www.statisticalstories.xyz (the \"Site\"). This Site is owned and operated by David Currie Software Development Ltd.. This Site is for helping its users learn about statistics and data science."),
