...
layout = html.Div(id='terms', children=[
    html.H3("Statistical Stories Privacy Policy"),
    html.P("Type of website: A blog to help people learn about statistics and data science."),
    html.P("Effective date: November 16th, 2023"),
    html.P("www.statisticalstories.xyz (the \"Site\") is owned and operated by David Currie Software Development Ltd.. David Currie Software Development Ltd. is the data controller and can be contacted at: david.currie32@gmail.com"),
    html.H4("Purpose"),
